...
public class VersmentDAO {
    ...
    public int insertVersment(Versment versment) {
        String sql = "INSERT INTO versment (client_id, montant, type, date_paiement, annee_concernee, created_at) "
                + "VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public Versment getVersmentById(int id) {
        String sql = "SELECT * FROM versment WHERE id = ?";
    ...
    public BigDecimal getTotalVersmentsByClientId(int clientId) {
        String sql = "SELECT SUM(montant) as total FROM versment WHERE client_id = ?";
